                ...
                <div class="contact-info-block p-8">
                    ...
                    <div class="flex space-x-4 items-center">
                        <a href="https://www.facebook.com/develixofficial/" target="_blank" class="social-icon facebook" aria-label="Facebook">
                            <img src="{{ asset('images/global/facebook-black.svg') }}" data-light="/images/global/facebook-black.svg" data-dark="/images/global/facebook.svg" class="mx-auto img-fluid theme-image" alt="Facebook icon" width="15" height="15" loading="eager">
                        </a>
                        <a href="https://www.instagram.com/develix_official/" target="_blank" class="social-icon instagram" aria-label="Instagram">
                            <img src="{{ asset('images/global/instagram-black.svg') }}" data-light="/images/global/instagram-black.svg" data-dark="/images/global/instagram.svg" class="mx-auto img-fluid theme-image" alt="Instagram icon" width="20" height="20" loading="eager">
                        </a>
                        <a href="https://www.linkedin.com/company/develix-official/" target="_blank" class="social-icon linkedin" aria-label="LinkedIn">
                            <img src="{{ asset('images/global/linkedin-black.svg') }}" data-light="/images/global/linkedin-black.svg" data-dark="/images/global/linkedin.svg" class="mx-auto img-fluid theme-image" alt="LinkedIn icon" width="20" height="20" loading="eager">
                        </a>
                        <a href="https://nl.pinterest.com/develix_official" target="_blank" class="social-icon pinterest" aria-label="LinkedIn">
                            <img src="{{ asset('images/global/pinterest-black.svg') }}" data-light="/images/global/pinterest-black.svg" data-dark="/images/global/pinterest.svg" class="mx-auto img-fluid theme-image" alt="LinkedIn icon" width="20" height="20" loading="eager">
                        </a>
                        <a href="https://x.com/DevelixOfficial" target="_blank" class="social-icon x-twitter" aria-label="LinkedIn">
                            <img src="{{ asset('images/global/x-twitter-black.svg') }}" data-light="/images/global/x-twitter-black.svg" data-dark="/images/global/x-twitter.svg" class="mx-auto img-fluid theme-image" alt="LinkedIn icon" width="20" height="20" loading="eager">
                        </a>
                    </div>
                </div>
            </div>

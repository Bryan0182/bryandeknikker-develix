            ...
            <div class="w-full md:w-1/3 px-4 my-4">
                <a href="{{ $service['url'] }}" class="block h-full text-center services-card shadow-lg rounded-lg overflow-hidden">
                    ...
                    <div class="card-button py-4">
                        <span class="align-items-center flex justify-center angle-right-button" style="--icon--angle-right-url: url('/images/develix.nl/develix-angle-right.svg'); --icon--angle-right-hover-url: url('/images/develix.nl/develix-angle-hover-right.svg');">Lees meer</span>
                    </div>
                </a>
            </div>
        @endforeach
